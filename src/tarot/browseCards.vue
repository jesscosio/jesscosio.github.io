...
const cards = {
  cups: [
    {
      id: 1,
      description:
        'Cups are assumed to represent people with light brown hair and of fair complexion.',
  ...
  pentacles: [
    {
      id: 1,
      description: 'Pentacles answer to very dark people.',
      title: 'Articulated',
  ...
  swords: [
    {
      id: 1,
      description: 'Correspond to persons with dark brown hair and possibly gray, hazel or even blue eyes.',
  ...
  wands: [
    {
      id: 1,
      description: 'Represent those having yellow or red hair and blue eyes. Wands symbolize creativity, enterprise, work and passion. The element is Fire.',
